...
!!! warning "TBD: opencode migration"
    This recitation walks through deploying a NodeBB instance to Azure. The course project is now [opencode](https://github.com/cmu-313/opencode), and it's not yet confirmed whether/how it gets deployed the same way — needs review before this recitation runs again.
