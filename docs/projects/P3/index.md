...
- have **at least one** one dynamic analysis tool
- have **at least one** tool that is not from our starter list of tools
...
!!! note "Time Management"
    Don’t spend too long for this checkpoint. Set deadlines within your team to ensure that you have enough time for both the design document and final integration deliverables described below for the final deadline.
...
Your answers should be based on your experiences running the tools on your team repository and be grounded in data, such as tool usability, output, and customizability.
...
- how often this new integration should run (on each pull request? on commits to main?)
- what level of customization is needed
- how it should be enforced, etc. 
