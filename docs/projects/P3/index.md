...
!!! note "Time Management"
    Don’t spend too long during this portion! Set deadlines within your team to ensure that you have enough time for both the design document and final integration deliverables described below.


By the checkpoint deadline, your team should have decided on your **initial list of the N-1 tools** that you plan on exploring, and you must have **successfully installed and run at least each of these tools on your repository.**

On Gradescope, submit your list of tools and a link to the PR that provides evidence to the tools that were successfully installed.
...
- **Social Integration Questions:** how do you foresee the team using the tool during their development process? What kind of motivation and incentive are your providing to the developers when it comes to using the tool?

Your answers should be based on your experiences running the tools on your team repository and, as much as possible, be grounded in data (such as tool usability, output, and customizability).
