...
- Issues you consider out of scope?
- Drawbacks of the proposed process/tooling that you are accepting for some (good) reason? 
...
This integration should be **merged into your main branch** and **must have been run at least once in the Git flow cycle** (i.e. either during the pull request, merge, or commit stage). Additionally, by the end of this project, your build on main **must pass successfully**; this is indicated by having a green checkmark.
