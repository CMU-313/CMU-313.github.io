...
You will each individually add a comment to your own PR containing answers to the following questions:
...
- A **justification section** detailing which tool you are choosing to integrate in your team's workflow and why
