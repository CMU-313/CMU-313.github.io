...
2. Create a pull request to the main branch from each of these testing branches. The PR should have
  ...
  - **Assessment of the pros/cons of your tool in the PR description**: In your evaluations, consider & experiment with the types of customization that are appropriate or necessary for this tool, both a priori (before it can be used in your project) and over time. Assess the strengths and weaknesses of your tool/technique, both quantitatively and qualitatively, with supporting evidence. 
