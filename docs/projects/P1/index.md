...
If you are not familiar with any of these steps, you are **highly recommended** to complete a short [Github Exercise](/projects/P1/github), as it will also cover the standards we are expecting in this class (which you will be graded upon as well). Refer to the [Resources & Documentation](#git--github-documentation) section if needed.
...
Follow the "Development Tools" section in the repository README, run both the linter and testing tools provided by NodeBB on your computer. Without any changes to the repository, both tools should pass. 
...
- the main page of NodeBB
- the coverage report opened in your browser
...
There's some restrictions on the `.js` file that you can pick, the file must
