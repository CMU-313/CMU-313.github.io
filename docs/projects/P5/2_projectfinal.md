...
!!! warning "Use of Generative AI Forbidden"
    As described in [the syllabus,](/docs/syllabus.md/#policy-on-use-of-generative-ai-for-writing) the use of generative AI tools for this part of the assignment is forbidden, and will be considered to be an academic integrity violation. 
