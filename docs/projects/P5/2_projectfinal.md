...
10.	**Extra Credit**  
Evidence that your changes have been accepted into the code base of the open source project in forms of links or screenshots. **Note: You can also send the merged PR link to the instructors via Slack to Group DM or e-mail(to both) by 18th December 1pm to claim this bonus as well**
