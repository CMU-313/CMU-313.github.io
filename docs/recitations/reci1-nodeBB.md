...
You should introduce yourself to the rest of the class. Please create a post in the "Introductions" category, which is only visible once you login (see note at the bottom of this page). You should include in your introduction the following info:
...
- A short summary of why you're taking this course (e.g., because it is a requirement for a specific program, because you hope to learn about X, etc.).
